...
**S27.** Your team operates this observability lab in production. Design an on-call rotation: (a) escalation policy, (b) runbook structure, (c) alert routing by severity, (d) handoff procedure, (e) post-incident review process. How do you prevent alert fatigue while ensuring critical issues are caught?
...
> **Scoring guidance:**
> - **Strong hire:** Can articulate trade-offs, references real experience, considers failure modes, teaches clearly
> - **Hire:** Solid technical depth, good troubleshooting process, identifies most issues
> - **Borderline:** Knows solutions but can't explain trade-offs, lacks production depth
> - **No hire:** Theoretical answers only, can't walk through systematic debugging, no awareness of blast radius
